...
class KNet4(nn.Module):
    def __init__(self):
        ...
        self.linear3 = nn.Linear(hidden1 + hidden2, 1)
    ...
    def forward(self, ref_sim):
        # testing24 with concatenation residual connection
