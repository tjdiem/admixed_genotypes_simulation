...
class KNet4(nn.Module):
    def __init__(self):
        ...
        self.linear4 = nn.Linear(10 * (num_classes * n_ind_pan_model), hidden3)
    ...
    def forward(self, ref_sim):
        # testing22 with relu instead of sigmoid after second reshape (and reshape to 10 instead of 20)
        ...
        ref_sim = self.relu(ref_sim) # batch, num_classes, 20 * num_classes * n_ind_pan_model
