...
class KNet4(nn.Module):
    def __init__(self):
        ...
        self.linear3 = nn.Linear(hidden2, 20)

        self.linear4 = nn.Linear(20 * (num_classes * n_ind_pan_model), hidden3)
    ...
    def forward(self, ref_sim):
        ...
        ref_sim = self.sigmoid(ref_sim) # batch, num_classes, 20 * num_classes * n_ind_pan_model
