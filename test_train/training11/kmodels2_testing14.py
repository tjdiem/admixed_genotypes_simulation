...
class KNet4(nn.Module):
    def __init__(self):
        ...
        self.linear2 = nn.Linear(hidden1 * n_ind_max, hidden2) 
    ...
    def forward(self, ref_sim):
        ...
        ref_sim = ref_sim.reshape(*ref_sim.shape[:2], -1) # batch, num_classes, n_ind_max * hidden1
        ...
        # ref_sim = self.relu(ref_sim).squeeze(-1) # batch, num_classes, num_classes * n_ind_pan_model
